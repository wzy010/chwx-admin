  ...
  export default{
    ...
    methods: {
      ...
      addPosition(){
        ...
        var _this = this;
        this.loading = true;
        this.postRequest(this.state == 'position' ? "api/system/basic/position" : "api/system/basic/joblevel", {
      ...
      doDelete(ids){
        var _this = this;
        _this.loading = true;
        var url = this.state == 'position' ? 'api/system/basic/position/' : 'api/system/basic/joblevel/';
      ...
      loadTableData(){
        var _this = this;
        this.loading = true;
        this.getRequest(this.state == 'position' ? "api/system/basic/positions" : "api/system/basic/joblevels").then(resp=> {
          _this.loading = false;
          if (resp && resp.status == 200) {
